...
1. Install Istio on Kubernetes, following [the default instructions](https://istio.io/docs/setup/kubernetes/install/kubernetes/) (use the istio-demo profile which does not strictly enforce mutual TLS auth between sidecars)
